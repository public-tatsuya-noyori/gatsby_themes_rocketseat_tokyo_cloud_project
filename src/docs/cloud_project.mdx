...
rclone lsf wasabi:japan.meteorological.agency.open.data/4PubSub/p4 | xargs -n1 -I{} rclone cat wasabi:japan.meteorological.agency.open.data/4PubSub/p4/{} | grep /bufr/satellite/asr/
